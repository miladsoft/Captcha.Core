...
export class LoginComponent implements OnInit {
  captchaApiUrl = "http://localhost:5000/CaptchaApi/CreateCaptcha";
  model = new LoginForm("Vahid", "");
  validationErrorMessage: string;
  success: boolean;
  @ViewChild("appCaptcha") appCaptcha: CaptchaComponent;
  ...
  submitForm(form: NgForm) {
    ...
    this.formPoster
      ...
      .subscribe(data => {
        ...
        this.success = true;
        this.appCaptcha.doRefresh(); // You can not send the same captcha twice.
      },
